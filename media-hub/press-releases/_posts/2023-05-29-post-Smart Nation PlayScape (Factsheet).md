...
|6a| Robotics I | This exhibit highlights how robots can learn or do things as well as (or better than) humans. <br><br>Guests can scramble a Rubik’s Cube and place it in a machine to watch how quickly the robot solves it.|
|6b| Robotics II | This exhibit showcases how robots can be programmed to do specific tasks repetitively and accurately.<br><br> Guests can programme a robot to dance by choosing a series of dance moves.|
